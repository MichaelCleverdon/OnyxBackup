 ...
 * Tests for Change Scenario 43: [A,B,C] -> set(2, D) -> [A,B,D]
 * 
 * @author Michael C
 */
public class Test_43_ABC_set2_ABD
{
	...
	//****** Constants used in tests *****************
		...
		private static final Object[][] VALID_ELEMENTS = { {TestCase.A}, {TestCase.B}, {TestCase.D} };
		...
		private static final Character LAST = TestCase.D;	
		// Elements in list with indexes
		private static final Object[][] INDEXED_VALID_ELEMENTS = { {0, TestCase.A}, {1, TestCase.B}, {2, TestCase.D} };
	...
	*/
	 ...
	 * Expected Result: Reference to ListIterator object that has starting index at index
	 */
	@Test(dataProvider = "validAddIndexes")
	public void testListIterator_validIndex(int validIndex)
	{
		TestCase.listIterator((IndexedUnsortedList<Character>)list, validIndex);
	}
	...
	public void testListIterator_invalidIndex(int invalidIndex)
	{
		TestCase.listIterator((IndexedUnsortedList<Character>)list, invalidIndex);
	}
