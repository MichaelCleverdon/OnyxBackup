 ...
 * Tests for Change Scenario 8: [A] -> addAfter(B,A) -> [A, B]
 * 
 * @author Michael C
 */
public class Test_8_A_addAfterBA_AB
{
	...
	//****** Constants used in tests *****************
		...
		private static final Object[][] VALID_ELEMENTS = { {TestCase.A}, {TestCase.B} };
		// First element in list
		private static final Character FIRST = TestCase.A;
		// Last element in list 
		private static final Character LAST = TestCase.B;	
		// Elements in list with indexes
		private static final Object[][] INDEXED_VALID_ELEMENTS = { {0, TestCase.A}, {1, TestCase.B} };
