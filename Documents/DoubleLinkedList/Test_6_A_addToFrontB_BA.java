 ...
 * Tests for Change Scenario 6: [A] -> addToFront(B) -> [B, A]
 * 
 * @author Michael C
 */
public class Test_6_A_addToFrontB_BA
{
	...
	//****** Constants used in tests *****************
		...
		private static final Object[][] VALID_ELEMENTS = { {TestCase.B}, {TestCase.A} };
		// First element in list
		private static final Character FIRST = TestCase.B;
		// Last element in list 
		private static final Character LAST = TestCase.A;	
		// Elements in list with indexes
		private static final Object[][] INDEXED_VALID_ELEMENTS = { {0, TestCase.B}, {1, TestCase.A} };
